 ...
 */
class kyTicketExtended extends kyObjectWithCustomFieldsBase {
	 ...
	 * @var int
	 */
	static protected $default_status_id = null;
	 ...
	 * @var int
	 */
	static protected $default_priority_id = null;
	 ...
	 * @var int
	 */
	static protected $default_type_id = null;
	 ...
	 * @var int
	 */
	static protected $auto_create_user = true;
	 ...
	 * @var array
	 */
	static protected $statistics = null;
	 ...
	 * @return kyResultSet
	 */
	static public function getAll($departments, $ticket_statuses = array(), $owner_staffs = array(), $users = array(), $max_items = null, $starting_ticket_id = null, $sort_field = null, $sort_order = null) {
		...
		if (is_string($sort_field))
			$search_parameters[] = $sort_field;
		
		if (is_string($sort_order))
			$search_parameters[] = $sort_order;
	...
	*/
	 ...
	 * @return kyTicket
	 */
	static protected function createNewGeneric($department, $contents, $subject) {
